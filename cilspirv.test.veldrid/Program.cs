...
namespace cilspirv.test.veldrid
{
    class Program
    {
        ...
        private static void CreateResources()
        {
            ...
            {
                actualColor = new Vector4(1f, 0f, 1f, 1f)
            };*/
            uint Align(uint min) => (min + 15) / 16 * 16;
            uniformBuffer = factory.CreateBuffer(new BufferDescription(Align((uint)test_shaders.Simple.Uniforms.Size), BufferUsage.UniformBuffer));
