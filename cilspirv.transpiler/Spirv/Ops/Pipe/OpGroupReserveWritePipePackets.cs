...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupReserveWritePipePackets : PipeInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupReserveWritePipePackets;
        ...
        public override IEnumerable<ID> AllIDs => new[] { ResultType1, Result2, Execution, Pipe, NumPackets, PacketSize, PacketAlignment };

        public OpGroupReserveWritePipePackets() {}

        private OpGroupReserveWritePipePackets(IReadOnlyList<uint> codes, Range range)
        {
