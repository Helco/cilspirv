...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpReadPipeBlockingINTEL : PipeInstruction
    {
        ...
        public override IEnumerable<ID> AllIDs => new[] { ResultType1, Result2, PacketSize, PacketAlignment };

        public OpReadPipeBlockingINTEL() {}

        private OpReadPipeBlockingINTEL(IReadOnlyList<uint> codes, Range range)
        {
