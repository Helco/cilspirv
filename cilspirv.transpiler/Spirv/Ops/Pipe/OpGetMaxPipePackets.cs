...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGetMaxPipePackets : PipeInstruction
    {
        ...
        public override IEnumerable<ID> AllIDs => new[] { ResultType, Result, Pipe, PacketSize, PacketAlignment }.Concat(ExtraIDs);

        public OpGetMaxPipePackets() {}

        private OpGetMaxPipePackets(IReadOnlyList<uint> codes, Range range)
        {
