...
{
    public sealed record OpISubBorrow : ArithmeticInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpISubBorrow;
        ...
        private OpISubBorrow(IReadOnlyList<uint> codes, Range range)
        {
