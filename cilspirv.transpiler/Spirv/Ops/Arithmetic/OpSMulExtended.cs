...
{
    public sealed record OpSMulExtended : ArithmeticInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpSMulExtended;
        ...
        private OpSMulExtended(IReadOnlyList<uint> codes, Range range)
        {
