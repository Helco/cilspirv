...
{
    public sealed record OpUMulExtended : ArithmeticInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpUMulExtended;
        ...
        private OpUMulExtended(IReadOnlyList<uint> codes, Range range)
        {
