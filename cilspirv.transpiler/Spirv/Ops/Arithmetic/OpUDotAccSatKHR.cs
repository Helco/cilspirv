...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpUDotAccSatKHR : ArithmeticInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpUDotAccSatKHR;
        ...
        public OpUDotAccSatKHR() {}

        private OpUDotAccSatKHR(IReadOnlyList<uint> codes, Range range)
        {
