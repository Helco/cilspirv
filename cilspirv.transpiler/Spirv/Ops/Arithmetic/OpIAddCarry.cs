...
{
    public sealed record OpIAddCarry : ArithmeticInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpIAddCarry;
        ...
        private OpIAddCarry(IReadOnlyList<uint> codes, Range range)
        {
