...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpMatrixTimesMatrix : ArithmeticInstruction
    {
        public ID ResultType1 { get; init; }
        public ID Result2 { get; init; }
        public ID LeftMatrix { get; init; }
        ...
        public override IEnumerable<ID> AllIDs => new[] { ResultType1, Result2, LeftMatrix, RightMatrix };

        public OpMatrixTimesMatrix() {}

        private OpMatrixTimesMatrix(IReadOnlyList<uint> codes, Range range)
        {
        ...
        public override void Write(Span<uint> codes)
        {
            ...
            codes[i++] = LeftMatrix.Value;
            codes[i++] = RightMatrix.Value;
        }
    }
}
