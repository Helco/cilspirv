...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpMatrixTimesScalar : ArithmeticInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpMatrixTimesScalar;
        public override int WordCount => 1 + 1 + 1 + 1 + 1;
        public override ID? ResultID => Result2;
        public override ID? ResultTypeID => ResultType1;

        public override IEnumerable<ID> AllIDs => new[] { ResultType1, Result2, Matrix, Scalar };

        public OpMatrixTimesScalar() {}

        private OpMatrixTimesScalar(IReadOnlyList<uint> codes, Range range)
        {
        ...
        public override void Write(Span<uint> codes)
        {
            ...
            codes[i++] = Matrix.Value;
            codes[i++] = Scalar.Value;
        }
    }
}
