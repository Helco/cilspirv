...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpTypeNamedBarrier : TypeDeclarationInstruction
    {
        public ID Result { get; init; }

        public override OpCode OpCode => OpCode.OpTypeNamedBarrier;
        ...
        private OpTypeNamedBarrier(IReadOnlyList<uint> codes, Range range)
        {
