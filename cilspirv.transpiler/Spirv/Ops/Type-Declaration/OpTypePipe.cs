...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpTypePipe : TypeDeclarationInstruction
    {
        public ID Result { get; init; }
        public AccessQualifier Qualifier { get; init; }

        public override OpCode OpCode => OpCode.OpTypePipe;
        ...
        private OpTypePipe(IReadOnlyList<uint> codes, Range range)
        {
