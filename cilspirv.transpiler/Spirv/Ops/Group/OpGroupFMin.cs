...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupFMin : GroupInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupFMin;
        ...
        private OpGroupFMin(IReadOnlyList<uint> codes, Range range)
        {
