...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupAny : GroupInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupAny;
        ...
        private OpGroupAny(IReadOnlyList<uint> codes, Range range)
        {
