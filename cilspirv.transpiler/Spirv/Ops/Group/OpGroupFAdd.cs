...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupFAdd : GroupInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupFAdd;
        ...
        private OpGroupFAdd(IReadOnlyList<uint> codes, Range range)
        {
