...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupUMax : GroupInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupUMax;
        ...
        private OpGroupUMax(IReadOnlyList<uint> codes, Range range)
        {
