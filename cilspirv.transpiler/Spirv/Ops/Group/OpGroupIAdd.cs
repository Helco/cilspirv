...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupIAdd : GroupInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupIAdd;
        ...
        private OpGroupIAdd(IReadOnlyList<uint> codes, Range range)
        {
