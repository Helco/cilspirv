...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupIAddNonUniformAMD : GroupInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupIAddNonUniformAMD;
        ...
        private OpGroupIAddNonUniformAMD(IReadOnlyList<uint> codes, Range range)
        {
