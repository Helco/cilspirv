...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpSubgroupAnyKHR : GroupInstruction
    {
        public ID ResultType { get; init; }
        public ID Result { get; init; }
        public ID Predicate { get; init; }

        public override OpCode OpCode => OpCode.OpSubgroupAnyKHR;
        ...
        private OpSubgroupAnyKHR(IReadOnlyList<uint> codes, Range range)
        {
