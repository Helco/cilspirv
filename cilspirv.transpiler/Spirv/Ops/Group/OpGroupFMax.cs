...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupFMax : GroupInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupFMax;
        ...
        private OpGroupFMax(IReadOnlyList<uint> codes, Range range)
        {
