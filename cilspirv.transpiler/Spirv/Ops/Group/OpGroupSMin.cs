...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupSMin : GroupInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupSMin;
        ...
        private OpGroupSMin(IReadOnlyList<uint> codes, Range range)
        {
