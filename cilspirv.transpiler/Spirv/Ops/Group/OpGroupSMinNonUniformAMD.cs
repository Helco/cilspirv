...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupSMinNonUniformAMD : GroupInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupSMinNonUniformAMD;
        ...
        private OpGroupSMinNonUniformAMD(IReadOnlyList<uint> codes, Range range)
        {
