...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupSMaxNonUniformAMD : GroupInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupSMaxNonUniformAMD;
        ...
        private OpGroupSMaxNonUniformAMD(IReadOnlyList<uint> codes, Range range)
        {
