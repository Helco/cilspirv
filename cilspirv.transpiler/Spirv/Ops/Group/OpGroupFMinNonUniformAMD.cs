...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupFMinNonUniformAMD : GroupInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupFMinNonUniformAMD;
        ...
        private OpGroupFMinNonUniformAMD(IReadOnlyList<uint> codes, Range range)
        {
