...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpDecorateId : AnnotationInstruction
    {
        public ID Target { get; init; }
        public Decoration Decoration { get; init; }

        public override OpCode OpCode => OpCode.OpDecorateId;
        ...
        private OpDecorateId(IReadOnlyList<uint> codes, Range range)
        {
