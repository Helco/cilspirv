...
{
    public sealed record OpAtomicLoad : AtomicInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpAtomicLoad;
        ...
        private OpAtomicLoad(IReadOnlyList<uint> codes, Range range)
        {
