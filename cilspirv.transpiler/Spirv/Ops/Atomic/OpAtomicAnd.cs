...
{
    public sealed record OpAtomicAnd : AtomicInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpAtomicAnd;
        ...
        private OpAtomicAnd(IReadOnlyList<uint> codes, Range range)
        {
