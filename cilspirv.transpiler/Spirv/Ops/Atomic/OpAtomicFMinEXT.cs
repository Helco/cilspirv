...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpAtomicFMinEXT : AtomicInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpAtomicFMinEXT;
        ...
        private OpAtomicFMinEXT(IReadOnlyList<uint> codes, Range range)
        {
