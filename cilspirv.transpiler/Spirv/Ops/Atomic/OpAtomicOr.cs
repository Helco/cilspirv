...
{
    public sealed record OpAtomicOr : AtomicInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpAtomicOr;
        ...
        private OpAtomicOr(IReadOnlyList<uint> codes, Range range)
        {
