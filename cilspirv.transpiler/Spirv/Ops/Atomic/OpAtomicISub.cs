...
{
    public sealed record OpAtomicISub : AtomicInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpAtomicISub;
        ...
        private OpAtomicISub(IReadOnlyList<uint> codes, Range range)
        {
