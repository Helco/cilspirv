...
{
    public sealed record OpAtomicUMax : AtomicInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpAtomicUMax;
        ...
        private OpAtomicUMax(IReadOnlyList<uint> codes, Range range)
        {
