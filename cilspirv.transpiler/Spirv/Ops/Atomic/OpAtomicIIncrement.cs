...
{
    public sealed record OpAtomicIIncrement : AtomicInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpAtomicIIncrement;
        ...
        private OpAtomicIIncrement(IReadOnlyList<uint> codes, Range range)
        {
