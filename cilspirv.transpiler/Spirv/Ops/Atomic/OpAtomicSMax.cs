...
{
    public sealed record OpAtomicSMax : AtomicInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpAtomicSMax;
        ...
        private OpAtomicSMax(IReadOnlyList<uint> codes, Range range)
        {
