...
{
    public sealed record OpAtomicIAdd : AtomicInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpAtomicIAdd;
        ...
        private OpAtomicIAdd(IReadOnlyList<uint> codes, Range range)
        {
