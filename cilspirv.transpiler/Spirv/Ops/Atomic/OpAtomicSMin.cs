...
{
    public sealed record OpAtomicSMin : AtomicInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpAtomicSMin;
        ...
        private OpAtomicSMin(IReadOnlyList<uint> codes, Range range)
        {
