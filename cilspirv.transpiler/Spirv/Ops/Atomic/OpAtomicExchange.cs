...
{
    public sealed record OpAtomicExchange : AtomicInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpAtomicExchange;
        ...
        private OpAtomicExchange(IReadOnlyList<uint> codes, Range range)
        {
