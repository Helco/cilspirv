...
{
    public sealed record OpShiftRightArithmetic : BitInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpShiftRightArithmetic;
        public override int WordCount => 1 + 1 + 1 + 1 + 1;
        public override ID? ResultID => Result2;
        public override ID? ResultTypeID => ResultType1;

        public override IEnumerable<ID> AllIDs => new[] { ResultType1, Result2, Base, Shift };

        public OpShiftRightArithmetic() {}

        private OpShiftRightArithmetic(IReadOnlyList<uint> codes, Range range)
        {
