...
{
    public sealed record OpBitwiseOr : BitInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpBitwiseOr;
        ...
        private OpBitwiseOr(IReadOnlyList<uint> codes, Range range)
        {
