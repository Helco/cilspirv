...
{
    public sealed record OpBitwiseAnd : BitInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpBitwiseAnd;
        ...
        private OpBitwiseAnd(IReadOnlyList<uint> codes, Range range)
        {
