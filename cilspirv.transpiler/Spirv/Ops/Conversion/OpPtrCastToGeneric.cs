...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpPtrCastToGeneric : ConversionInstruction
    {
        public ID ResultType { get; init; }
        public ID Result { get; init; }
        public ID Pointer { get; init; }

        public override OpCode OpCode => OpCode.OpPtrCastToGeneric;
        ...
        private OpPtrCastToGeneric(IReadOnlyList<uint> codes, Range range)
        {
