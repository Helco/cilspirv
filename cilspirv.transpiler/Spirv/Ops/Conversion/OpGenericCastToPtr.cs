...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGenericCastToPtr : ConversionInstruction
    {
        public ID ResultType1 { get; init; }
        public ID Result2 { get; init; }
        public ID Pointer { get; init; }

        public override OpCode OpCode => OpCode.OpGenericCastToPtr;
        ...
        private OpGenericCastToPtr(IReadOnlyList<uint> codes, Range range)
        {
