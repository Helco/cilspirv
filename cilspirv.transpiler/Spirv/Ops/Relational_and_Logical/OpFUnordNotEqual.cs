...
{
    public sealed record OpFUnordNotEqual : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpFUnordNotEqual;
        ...
        private OpFUnordNotEqual(IReadOnlyList<uint> codes, Range range)
        {
