...
{
    public sealed record OpFUnordLessThanEqual : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpFUnordLessThanEqual;
        ...
        private OpFUnordLessThanEqual(IReadOnlyList<uint> codes, Range range)
        {
