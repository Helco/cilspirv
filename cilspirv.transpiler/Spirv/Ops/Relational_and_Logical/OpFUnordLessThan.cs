...
{
    public sealed record OpFUnordLessThan : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpFUnordLessThan;
        ...
        private OpFUnordLessThan(IReadOnlyList<uint> codes, Range range)
        {
