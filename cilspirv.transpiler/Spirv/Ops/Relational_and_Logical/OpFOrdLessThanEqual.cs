...
{
    public sealed record OpFOrdLessThanEqual : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpFOrdLessThanEqual;
        ...
        private OpFOrdLessThanEqual(IReadOnlyList<uint> codes, Range range)
        {
