...
{
    public sealed record OpFOrdGreaterThanEqual : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpFOrdGreaterThanEqual;
        ...
        private OpFOrdGreaterThanEqual(IReadOnlyList<uint> codes, Range range)
        {
