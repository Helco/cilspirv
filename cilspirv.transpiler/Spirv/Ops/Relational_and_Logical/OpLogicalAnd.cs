...
{
    public sealed record OpLogicalAnd : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpLogicalAnd;
        ...
        private OpLogicalAnd(IReadOnlyList<uint> codes, Range range)
        {
