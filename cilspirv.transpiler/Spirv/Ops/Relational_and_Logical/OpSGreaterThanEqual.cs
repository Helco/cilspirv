...
{
    public sealed record OpSGreaterThanEqual : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpSGreaterThanEqual;
        ...
        private OpSGreaterThanEqual(IReadOnlyList<uint> codes, Range range)
        {
