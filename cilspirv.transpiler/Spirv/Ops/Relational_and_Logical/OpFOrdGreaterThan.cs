...
{
    public sealed record OpFOrdGreaterThan : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpFOrdGreaterThan;
        ...
        private OpFOrdGreaterThan(IReadOnlyList<uint> codes, Range range)
        {
