...
{
    public sealed record OpLogicalEqual : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpLogicalEqual;
        ...
        private OpLogicalEqual(IReadOnlyList<uint> codes, Range range)
        {
