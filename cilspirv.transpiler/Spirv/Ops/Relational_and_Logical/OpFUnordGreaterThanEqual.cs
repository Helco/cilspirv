...
{
    public sealed record OpFUnordGreaterThanEqual : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpFUnordGreaterThanEqual;
        ...
        private OpFUnordGreaterThanEqual(IReadOnlyList<uint> codes, Range range)
        {
