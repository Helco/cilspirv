...
{
    public sealed record OpINotEqual : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpINotEqual;
        ...
        private OpINotEqual(IReadOnlyList<uint> codes, Range range)
        {
