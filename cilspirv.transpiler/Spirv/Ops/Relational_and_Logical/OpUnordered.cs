...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpUnordered : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpUnordered;
        public override int WordCount => 1 + 1 + 1 + 1 + 1;
        public override ID? ResultID => Result2;
        public override ID? ResultTypeID => ResultType1;

        public override IEnumerable<ID> AllIDs => new[] { ResultType1, Result2, x, y };

        public OpUnordered() {}

        private OpUnordered(IReadOnlyList<uint> codes, Range range)
        {
