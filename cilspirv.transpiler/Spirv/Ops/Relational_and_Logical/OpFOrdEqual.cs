...
{
    public sealed record OpFOrdEqual : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpFOrdEqual;
        ...
        private OpFOrdEqual(IReadOnlyList<uint> codes, Range range)
        {
