...
{
    public sealed record OpFUnordGreaterThan : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpFUnordGreaterThan;
        ...
        private OpFUnordGreaterThan(IReadOnlyList<uint> codes, Range range)
        {
