...
{
    public sealed record OpULessThan : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpULessThan;
        ...
        private OpULessThan(IReadOnlyList<uint> codes, Range range)
        {
