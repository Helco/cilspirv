...
{
    public sealed record OpUGreaterThanEqual : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpUGreaterThanEqual;
        ...
        private OpUGreaterThanEqual(IReadOnlyList<uint> codes, Range range)
        {
