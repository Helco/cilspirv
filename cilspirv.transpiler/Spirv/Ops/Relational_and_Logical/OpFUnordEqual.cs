...
{
    public sealed record OpFUnordEqual : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpFUnordEqual;
        ...
        private OpFUnordEqual(IReadOnlyList<uint> codes, Range range)
        {
