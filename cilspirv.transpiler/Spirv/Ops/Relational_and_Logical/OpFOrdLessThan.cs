...
{
    public sealed record OpFOrdLessThan : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpFOrdLessThan;
        ...
        private OpFOrdLessThan(IReadOnlyList<uint> codes, Range range)
        {
