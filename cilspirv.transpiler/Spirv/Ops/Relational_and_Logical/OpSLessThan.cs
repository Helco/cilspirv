...
{
    public sealed record OpSLessThan : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpSLessThan;
        ...
        private OpSLessThan(IReadOnlyList<uint> codes, Range range)
        {
