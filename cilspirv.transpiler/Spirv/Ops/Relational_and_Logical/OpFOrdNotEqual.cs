...
{
    public sealed record OpFOrdNotEqual : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpFOrdNotEqual;
        ...
        private OpFOrdNotEqual(IReadOnlyList<uint> codes, Range range)
        {
