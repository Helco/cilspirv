...
{
    public sealed record OpLogicalNotEqual : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpLogicalNotEqual;
        ...
        private OpLogicalNotEqual(IReadOnlyList<uint> codes, Range range)
        {
