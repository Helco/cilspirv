...
{
    public sealed record OpUGreaterThan : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpUGreaterThan;
        ...
        private OpUGreaterThan(IReadOnlyList<uint> codes, Range range)
        {
