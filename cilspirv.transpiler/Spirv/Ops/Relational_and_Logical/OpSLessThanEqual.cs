...
{
    public sealed record OpSLessThanEqual : RelationalAndLogicalInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpSLessThanEqual;
        ...
        private OpSLessThanEqual(IReadOnlyList<uint> codes, Range range)
        {
