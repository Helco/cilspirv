...
{
    public sealed record OpConstantFalse : ConstantCreationInstruction
    {
        public ID ResultType1 { get; init; }
        public ID Result2 { get; init; }

        public override OpCode OpCode => OpCode.OpConstantFalse;
        ...
        private OpConstantFalse(IReadOnlyList<uint> codes, Range range)
        {
