...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpConstantCompositeContinuedINTEL : ConstantCreationInstruction
    {
        public ImmutableArray<ID> Constituents { get; init; }

        public override OpCode OpCode => OpCode.OpConstantCompositeContinuedINTEL;
        ...
        private OpConstantCompositeContinuedINTEL(IReadOnlyList<uint> codes, Range range)
        {
