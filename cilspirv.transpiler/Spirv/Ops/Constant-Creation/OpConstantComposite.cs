...
{
    public sealed record OpConstantComposite : ConstantCreationInstruction
    {
        public ID ResultType { get; init; }
        public ID Result { get; init; }
        public ImmutableArray<ID> Constituents { get; init; }

        public override OpCode OpCode => OpCode.OpConstantComposite;
        ...
        private OpConstantComposite(IReadOnlyList<uint> codes, Range range)
        {
