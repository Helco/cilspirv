...
{
    public sealed record OpSpecConstantTrue : ConstantCreationInstruction
    {
        public ID ResultType { get; init; }
        public ID Result { get; init; }

        public override OpCode OpCode => OpCode.OpSpecConstantTrue;
        ...
        private OpSpecConstantTrue(IReadOnlyList<uint> codes, Range range)
        {
