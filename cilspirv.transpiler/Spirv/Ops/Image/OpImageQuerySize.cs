...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpImageQuerySize : ImageInstruction
    {
        public ID ResultType { get; init; }
        public ID Result { get; init; }
        public ID Image { get; init; }

        public override OpCode OpCode => OpCode.OpImageQuerySize;
        ...
        private OpImageQuerySize(IReadOnlyList<uint> codes, Range range)
        {
