...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpImageQueryLod : ImageInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpImageQueryLod;
        ...
        private OpImageQueryLod(IReadOnlyList<uint> codes, Range range)
        {
