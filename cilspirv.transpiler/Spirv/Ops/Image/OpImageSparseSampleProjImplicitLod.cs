...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpImageSparseSampleProjImplicitLod : ImageInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpImageSparseSampleProjImplicitLod;
        ...
        private OpImageSparseSampleProjImplicitLod(IReadOnlyList<uint> codes, Range range)
        {
