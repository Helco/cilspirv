...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpImageSampleFootprintNV : ImageInstruction
    {
        ...
        public override int WordCount => 1 + 1 + 1 + 1 + 1 + 1 + 1 + (ImageOperands3.HasValue ? 1 : 0);
        public override ID? ResultID => Result2;
        public override ID? ResultTypeID => ResultType1;

        public override IEnumerable<ID> AllIDs => new[] { ResultType1, Result2, SampledImage, Coordinate, Granularity, Coarse };
        ...
        public override void Write(Span<uint> codes)
        {
            ...
            codes[i++] = Granularity.Value;
            codes[i++] = Coarse.Value;
