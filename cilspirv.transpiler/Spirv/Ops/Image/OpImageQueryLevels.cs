...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpImageQueryLevels : ImageInstruction
    {
        public ID ResultType { get; init; }
        public ID Result { get; init; }
        public ID Image { get; init; }

        public override OpCode OpCode => OpCode.OpImageQueryLevels;
        ...
        private OpImageQueryLevels(IReadOnlyList<uint> codes, Range range)
        {
