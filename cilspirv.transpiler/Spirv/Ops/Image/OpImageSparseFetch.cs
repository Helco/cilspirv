...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpImageSparseFetch : ImageInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpImageSparseFetch;
        ...
        private OpImageSparseFetch(IReadOnlyList<uint> codes, Range range)
        {
