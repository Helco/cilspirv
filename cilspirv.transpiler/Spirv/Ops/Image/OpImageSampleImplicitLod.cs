...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpImageSampleImplicitLod : ImageInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpImageSampleImplicitLod;
        ...
        private OpImageSampleImplicitLod(IReadOnlyList<uint> codes, Range range)
        {
