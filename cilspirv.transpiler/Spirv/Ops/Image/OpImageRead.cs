...
{
    public sealed record OpImageRead : ImageInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpImageRead;
        ...
        private OpImageRead(IReadOnlyList<uint> codes, Range range)
        {
