...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpImageDrefGather : ImageInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpImageDrefGather;
        ...
        private OpImageDrefGather(IReadOnlyList<uint> codes, Range range)
        {
