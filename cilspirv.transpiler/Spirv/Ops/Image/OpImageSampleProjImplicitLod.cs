...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpImageSampleProjImplicitLod : ImageInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpImageSampleProjImplicitLod;
        ...
        private OpImageSampleProjImplicitLod(IReadOnlyList<uint> codes, Range range)
        {
