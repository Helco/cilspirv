...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupNonUniformAny : NonUniformInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupNonUniformAny;
        ...
        private OpGroupNonUniformAny(IReadOnlyList<uint> codes, Range range)
        {
