...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupNonUniformShuffleUp : NonUniformInstruction
    {
        ...
        public override IEnumerable<ID> AllIDs => new[] { ResultType, Result, Execution, Value, Delta }.Concat(ExtraIDs);

        public OpGroupNonUniformShuffleUp() {}

        private OpGroupNonUniformShuffleUp(IReadOnlyList<uint> codes, Range range)
        {
