...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupNonUniformFAdd : NonUniformInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupNonUniformFAdd;
        ...
        private OpGroupNonUniformFAdd(IReadOnlyList<uint> codes, Range range)
        {
