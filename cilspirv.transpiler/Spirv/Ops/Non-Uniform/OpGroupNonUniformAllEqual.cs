...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupNonUniformAllEqual : NonUniformInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupNonUniformAllEqual;
        ...
        private OpGroupNonUniformAllEqual(IReadOnlyList<uint> codes, Range range)
        {
