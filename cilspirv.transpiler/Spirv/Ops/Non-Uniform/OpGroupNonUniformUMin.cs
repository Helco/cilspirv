...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupNonUniformUMin : NonUniformInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupNonUniformUMin;
        ...
        private OpGroupNonUniformUMin(IReadOnlyList<uint> codes, Range range)
        {
