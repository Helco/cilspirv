...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupNonUniformIMul : NonUniformInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupNonUniformIMul;
        ...
        private OpGroupNonUniformIMul(IReadOnlyList<uint> codes, Range range)
        {
