...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupNonUniformFMax : NonUniformInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupNonUniformFMax;
        ...
        private OpGroupNonUniformFMax(IReadOnlyList<uint> codes, Range range)
        {
