...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupNonUniformUMax : NonUniformInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupNonUniformUMax;
        ...
        private OpGroupNonUniformUMax(IReadOnlyList<uint> codes, Range range)
        {
