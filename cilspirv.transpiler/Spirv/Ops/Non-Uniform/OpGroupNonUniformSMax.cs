...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupNonUniformSMax : NonUniformInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupNonUniformSMax;
        ...
        private OpGroupNonUniformSMax(IReadOnlyList<uint> codes, Range range)
        {
