...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupNonUniformIAdd : NonUniformInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupNonUniformIAdd;
        ...
        private OpGroupNonUniformIAdd(IReadOnlyList<uint> codes, Range range)
        {
