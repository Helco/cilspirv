...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGroupNonUniformInverseBallot : NonUniformInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpGroupNonUniformInverseBallot;
        ...
        private OpGroupNonUniformInverseBallot(IReadOnlyList<uint> codes, Range range)
        {
