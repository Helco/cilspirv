...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpPtrNotEqual : MemoryInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpPtrNotEqual;
        ...
        private OpPtrNotEqual(IReadOnlyList<uint> codes, Range range)
        {
