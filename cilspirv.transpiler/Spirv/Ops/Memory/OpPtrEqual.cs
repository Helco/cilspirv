...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpPtrEqual : MemoryInstruction
    {
        ...
        public override OpCode OpCode => OpCode.OpPtrEqual;
        ...
        private OpPtrEqual(IReadOnlyList<uint> codes, Range range)
        {
