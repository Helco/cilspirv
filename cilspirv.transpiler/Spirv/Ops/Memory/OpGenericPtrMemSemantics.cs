...
namespace cilspirv.Spirv.Ops
{
    ...
    public sealed record OpGenericPtrMemSemantics : MemoryInstruction
    {
        public ID ResultType1 { get; init; }
        public ID Result2 { get; init; }
        public ID Pointer { get; init; }

        public override OpCode OpCode => OpCode.OpGenericPtrMemSemantics;
        ...
        private OpGenericPtrMemSemantics(IReadOnlyList<uint> codes, Range range)
        {
