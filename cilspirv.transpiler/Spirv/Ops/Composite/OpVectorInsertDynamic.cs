...
{
    public sealed record OpVectorInsertDynamic : CompositeInstruction
    {
        ...
        public override IEnumerable<ID> AllIDs => new[] { ResultType1, Result2, Vector, Component, Index };

        public OpVectorInsertDynamic() {}

        private OpVectorInsertDynamic(IReadOnlyList<uint> codes, Range range)
        {
